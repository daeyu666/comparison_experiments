"""Shared benchmark helpers for the UAFL reproduction."""
...
def build_shared_cfg(args) -> TrainConfig:
    ...
    cfg.n_select_bands = cfg.datasets[cfg.dataset].n_select_bands
...
def require_srf_weights(info) -> torch.Tensor:
    ...
    if weights is None:
        raise RuntimeError(
            "UAFL HSI-MSI benchmark requires shared sensor SRF weights; "
